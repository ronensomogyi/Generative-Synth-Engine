...
from AE.train import load_mnist
...
def main():
    ...
    num_sample_images = 8
    sample_images, _ = select_images(x_test, y_test, num_sample_images) # images and labels
    ...
    _, latent_reps = autoencoder.reconstruct(sample_images)
